...
namespace HASS.Agent.Controls.Configuration
{
    public partial class ConfigExternalTools : UserControl
    {
        ...
        private void BtnExternalBrowserIncognitoTest_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(this, Languages.ConfigExternalTools_BtnExternalBrowserIncognitoTest_MessageBox1, Variables.MessageBoxTitle, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            ...
            {
                MessageBox.Show(this, Languages.ConfigExternalTools_ConfigExternalTools_BtnExternalBrowserIncognitoTest_MessageBox2, Variables.MessageBoxTitle, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                ActiveControl = TbExternalBrowserBinary;
                return;
            }
            ...
            {
                var q = MessageBox.Show(this, Languages.ConfigExternalTools_BtnExternalBrowserIncognitoTest_MessageBox3, Variables.MessageBoxTitle, MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show(this, Languages.ConfigExternalTools_BtnExternalBrowserIncognitoTest_MessageBox4, Variables.MessageBoxTitle, MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
